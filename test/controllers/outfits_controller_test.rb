...
class OutfitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create outfit" do
    assert_difference('Outfit.count') do
      post outfits_url, params: { outfit: { formality: @outfit.formality, name: @outfit.name, work: @outfit.work } }
    end
  ...
  test "should update outfit" do
    patch outfit_url(@outfit), params: { outfit: { formality: @outfit.formality, name: @outfit.name, work: @outfit.work } }
